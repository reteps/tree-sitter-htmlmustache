...
enum ts_symbol_identifiers {
  ...
  anon_sym_LT_SLASH = 7,
  anon_sym_EQ = 8,
  sym_html_attribute_name = 9,
  sym_html_attribute_value = 10,
  sym_html_entity = 11,
  anon_sym_SQUOTE = 12,
  aux_sym_html_quoted_attribute_value_token1 = 13,
  anon_sym_DQUOTE = 14,
  aux_sym_html_quoted_attribute_value_token2 = 15,
  sym_html_text = 16,
  sym__html_start_tag_name = 17,
  sym__html_script_start_tag_name = 18,
  sym__html_style_start_tag_name = 19,
  sym__html_end_tag_name = 20,
  sym_html_erroneous_end_tag_name = 21,
  sym__html_implicit_end_tag = 22,
  sym_html_raw_text = 23,
  sym_html_comment = 24,
  sym_document = 25,
  sym_html_doctype = 26,
  sym__html_node = 27,
  sym_html_element = 28,
  sym_html_script_element = 29,
  sym_html_style_element = 30,
  sym_html_start_tag = 31,
  sym_html_script_start_tag = 32,
  sym_html_style_start_tag = 33,
  sym_html_self_closing_tag = 34,
  sym_html_end_tag = 35,
  sym_html_erroneous_end_tag = 36,
  sym_html_attribute = 37,
  sym_html_quoted_attribute_value = 38,
...
static const char * const ts_symbol_names[] = {
  ...
  [sym__html_script_start_tag_name] = "tag_name",
  [sym__html_style_start_tag_name] = "tag_name",
  [sym__html_end_tag_name] = "tag_name",
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_html_doctype] = STATE(7),
    [sym__html_node] = STATE(7),
    [sym_html_element] = STATE(7),
    [sym_html_script_element] = STATE(7),
    [sym_html_style_element] = STATE(7),
    [sym_html_start_tag] = STATE(2),
    [sym_html_script_start_tag] = STATE(48),
    [sym_html_style_start_tag] = STATE(53),
    [sym_html_self_closing_tag] = STATE(33),
    [sym_html_erroneous_end_tag] = STATE(7),
    [aux_sym_document_repeat1] = STATE(7),
    [ts_builtin_sym_end] = ACTIONS(5),
    [anon_sym_LT_BANG] = ACTIONS(7),
    [anon_sym_LT] = ACTIONS(9),
    [anon_sym_LT_SLASH] = ACTIONS(11),
    [sym_html_entity] = ACTIONS(13),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_style_element, 2, 0, 0),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_style_element, 2, 0, 0),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_start_tag, 3, 0, 0),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_start_tag, 3, 0, 0),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_self_closing_tag, 3, 0, 0),
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_self_closing_tag, 3, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_erroneous_end_tag, 3, 0, 0),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_erroneous_end_tag, 3, 0, 0),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_element, 3, 0, 0),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_element, 3, 0, 0),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_script_element, 3, 0, 0),
  [93] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_script_element, 3, 0, 0),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_style_element, 3, 0, 0),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_style_element, 3, 0, 0),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_doctype, 4, 0, 0),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_doctype, 4, 0, 0),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_start_tag, 4, 0, 0),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_start_tag, 4, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_script_element, 2, 0, 0),
  [109] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_script_element, 2, 0, 0),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_element, 1, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_element, 1, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_element, 2, 0, 0),
  [117] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_element, 2, 0, 0),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_self_closing_tag, 4, 0, 0),
  [121] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_html_self_closing_tag, 4, 0, 0),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_html_start_tag_repeat1, 2, 0, 0),
  [125] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_html_start_tag_repeat1, 2, 0, 0), SHIFT_REPEAT(45),
  ...
  [146] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_html_start_tag_repeat1, 2, 0, 0), SHIFT_REPEAT(51),
  [149] = {.entry = {.count = 1, .reusable = true}}, SHIFT(66),
  [151] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [153] = {.entry = {.count = 1, .reusable = true}}, SHIFT(65),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_attribute, 1, 0, 0),
  ...
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_quoted_attribute_value, 2, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_quoted_attribute_value, 3, 0, 0),
  ...
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_attribute, 3, 0, 0),
  [197] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [199] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [201] = {.entry = {.count = 1, .reusable = true}}, SHIFT(91),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_script_start_tag, 3, 0, 0),
  [205] = {.entry = {.count = 1, .reusable = false}}, SHIFT(49),
  [207] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_script_start_tag, 4, 0, 0),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_style_start_tag, 3, 0, 0),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_style_start_tag, 4, 0, 0),
